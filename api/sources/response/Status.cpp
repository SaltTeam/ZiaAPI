...
namespace Zia
{
    ...
    inline void Status::setStandardStatus(StatusCode code)
    {
        this->_code = code;
        this->_text = statusText.at(code);
    }

    inline void Status::setCustomStatus(unsigned int code, const std::string &text)
    {
        this->_code = code;
        this->_text = text;
    }

    inline unsigned int Status::getCode() const
    {
        return this->_code;
    }

    inline const std::string &Status::getText() const
    {
        return this->_text;
    }
